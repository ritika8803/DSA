...
// job for him since he has a nifty new woodcutting machine that can take down
// forests like wildfire. However, Mirko is only allowed to cut a single row of trees.
...
// higher than H (of course, trees not higher than H meters remain intact). Mirko then 
// takes the parts that were cut off. For example, if the tree row contains trees with 
...
// respectively, while Mirko will take 5 metres off the first tree and 2 metres 
...
// Mirko find the maximum integer height of the sawblade that still allows him to 
// cut off at least M metres of wood.
// Input
// The first line of input contains two space-separated positive integers, 
// N (the number of trees, 1 ≤ N ≤ 1 000 000) and M (Mirko‟s required wood amount,
//  1 ≤ M ≤ 2 000 000 000).
// The second line of input contains N space-separated positive integers 
// less than 1 000 000 000, the heights of each tree (in metres). The sum of all 
